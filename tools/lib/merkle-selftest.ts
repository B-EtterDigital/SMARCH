 ...
 * @example node tools/lib/merkle-selftest.ts
 */
/**
 ...
 * Run: node tools/lib/merkle-selftest.ts
 */
import assert from 'node:assert/strict';
import { leafHash, buildMerkle, inclusionProof, verifyProof, verifyBrickInclusion } from './merkle.ts';
