 ...
 * @example node --input-type=module -e "import { similarity } from './tools/lib/similarity.ts'; console.log(similarity('const x = 1;', 'const y = 1;'));"
 */
/**
 * similarity.ts — near-duplicate ("fuzzy") source-code detection.
 *
