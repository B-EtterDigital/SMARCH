 ...
 * Example: `node tools/sma-refresh-manifest-budgets.ts --help`
 */
...
Usage:
  node tools/sma-refresh-manifest-budgets.ts --root <project-root> --scan <scan-file>
  node tools/sma-refresh-manifest-budgets.ts --root <project-root> --all-manifests --project-id <id> --sync-project-id
