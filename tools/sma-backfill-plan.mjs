 ...
 * lazily by sma-backfill-run.mjs to keep planning fast and deterministic.
 */
...
function usage() {
  console.log(`Usage:
  sma-backfill-plan.mjs generate [--limit 500] [--phase <n>] [--project <id>]
                                 [--status <s>] [--min-composite-score <n>]
                                 [--registry <path>] [--out <path>]
  sma-backfill-plan.mjs show     --plan <path> [--top 20] [--json]
  sma-backfill-plan.mjs stats    --plan <path> [--json]
`);
}
