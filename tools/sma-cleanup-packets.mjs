...
const START_EDIT = resolve(SMA_ROOT, 'tools/sma-start-edit.mjs');
...
function usage() {
  console.log(`Usage:
  sma-cleanup-packets.mjs list [--project <id>] [--limit 12] [--available-only] [--progress] [--json]
                               [--allow-stale] [--no-auto-refresh]
  sma-cleanup-packets.mjs progress [--project <id>] [--limit 12] [--available-only] [--json]
                                   [--allow-stale] [--no-auto-refresh]
  sma-cleanup-packets.mjs wave [--project <id>] [--limit 12] [--available-only] [--json]
                               [--write-dispatch [path]]
                               [--allow-blocked-dispatch]
                               [--allow-stale] [--no-auto-refresh]
  sma-cleanup-packets.mjs show (--rank <n>|--next) [--json]
                               [--allow-stale] [--no-auto-refresh]
  sma-cleanup-packets.mjs claim (--rank <n>|--next|--project <id> --brick <id> --group <path>)
...
function decoratedPacketReportWithOptionalRefresh(options = {}) {
  let report = readPacketReport();
...
function cleanupWavePrompt(packet, options = {}) {
...
function cleanupPinnedClaimCommand(packet, options = {}) {
  const parts = [
