...
Usage:
  node tools/sma-validate.mjs --manifest path/to/module.sweetspot.json
  node tools/sma-validate.mjs --root ~/DEV/Projects
  node tools/sma-validate.mjs --registry registry/global-modules.generated.json
`);
      process.exit(0);
    }
  }
