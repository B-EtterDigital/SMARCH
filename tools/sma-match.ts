 ...
 * Usage: `node tools/sma-match.ts --registry registry/global-modules.generated.json --vision "local dashboard" --top 5`
 */
/**
 * sma-match: match a product vision against the brick registry.
 *
 * Usage:
 *   node tools/sma-match.ts --vision "I want to build an Electron app with multi-provider chat and screen capture"
 *   node tools/sma-match.ts --vision-file ./vision.txt --top 15 --min-status candidate
 *
