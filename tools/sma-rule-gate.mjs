...
Usage:
  node tools/sma-rule-gate.mjs --manifest <path>          gate a single brick
  node tools/sma-rule-gate.mjs --all                       gate every build under builds/
  node tools/sma-rule-gate.mjs --manifest <path> --json    machine-readable output
