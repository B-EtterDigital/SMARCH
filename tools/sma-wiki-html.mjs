#!/usr/bin/env node
/**
 * sma-wiki-html: render every wiki/bricks-detailed/<project>/*.md page as a
 * BRICKWORKS-themed HTML page that matches the brick-wall aesthetic.
 *
 * Inputs:   wiki/bricks-detailed/<project>/<slug>.md (generated by sma-codex-wiki)
 * Outputs:  wiki/bricks-detailed/<project>/<slug>.html   (main reference)
 *           wiki/bricks-detailed/<project>/INDEX.html    (project TOC)
 *           wiki/bricks-detailed/index.html              (global master TOC)
 *
 * No LLM calls. Pure markdown→HTML. Uses a tiny in-tool markdown renderer
 * that handles the subset our wiki emits: headings, paragraphs, lists,
 * tables, fenced code blocks, inline code, emphasis, blockquotes, links,
 * horizontal rules.
 */
