 ...
 * Usage: `node tools/sma-codex-wiki.ts --limit 1 --dry-run`
 */
/**
 ...
 *
 * Usage:
 *   node tools/sma-codex-wiki.ts                           # all approved bricks
 *   node tools/sma-codex-wiki.ts --limit 20                # smoke test
 *   node tools/sma-codex-wiki.ts --filter cascadepipeline  # one brick
 *   node tools/sma-codex-wiki.ts --statuses canonical,candidate
 */
...
async function main(): Promise<void> {
  ...
  for (const p of projects) {
    ...
    } catch { /* optional generated project directory */ }
  }
