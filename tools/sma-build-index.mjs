...
Usage:
  node tools/sma-build-index.mjs
  node tools/sma-build-index.mjs --root builds --releases releases/release-index.generated.json --out builds/build-index.generated.json
