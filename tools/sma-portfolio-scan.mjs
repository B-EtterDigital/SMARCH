...
const stateScriptPath = path.resolve(repoRoot, "tools/sma-state.mjs");
const repoQueuesScriptPath = path.resolve(repoRoot, "tools/sma-repo-queues.mjs");
const mergeScriptPath = path.resolve(repoRoot, "tools/sma-merge-registries.mjs");
const scanScriptPath = path.resolve(repoRoot, "tools/sma-scan.mjs");

const HELP_TEXT = `Usage: node tools/sma-portfolio-scan.mjs [options]
