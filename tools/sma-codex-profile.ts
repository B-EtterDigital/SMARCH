 ...
 * Usage: `node tools/sma-codex-profile.ts --help`
 */
/**
 * sma-codex-profile.ts - read-only Codex startup hygiene audit for SMA Gen3.
 *
...
function usage(): void {
  ...
  sma-codex-profile.ts audit [--json] [--codex-home <path>] [--agents-home <path>]
                              ...
                              [--no-plugin-cache]
  sma-codex-profile.ts lean [--profile sma] [--apply] [--json]
                             [--manifest-dir <path>] [--include <skill>]
                             [--exclude <skill>]
  sma-codex-profile.ts restore [--manifest <path>|--latest] [--apply] [--json]
                                [--manifest-dir <path>]
  sma-codex-profile.ts selftest
...
function skillBudgetRisk(bytes: number): string {
...
function percent(part: unknown, whole: unknown): number {
  if (!whole) return 0;
