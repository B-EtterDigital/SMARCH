 ...
 * Usage: `node tools/sma-conflict.ts summary --project sma --limit 5`
 */
/**
 * sma-conflict.ts — mandatory collision reports for SMA Gen3 agents.
 *
...
function usage() {
  console.log(`Usage:
  sma-conflict.ts report  --project <id> --brick <id> --intent "..."
  ...
  sma-conflict.ts list    --project <id> [--brick <id>] [--open] [--json]

  sma-conflict.ts check   --project <id> [--brick <id>] [--strict] [--json]
