...
function usage() {
  console.log(`Usage:
  sma-stats.mjs summary [--since 7d|30d|90d|<iso>] [--project <id>]... [--json]
                        [--exclude-vendored]
  sma-stats.mjs trend   [--since 30d] [--project <id>]... [--by day|week] [--json]
                        [--exclude-vendored]
  sma-stats.mjs top     [--since 30d] [--metric agent|session|brick|kind] [--n 10] [--json]
                        [--exclude-vendored]
