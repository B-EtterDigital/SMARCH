...
function codeQualityMatchCount(counts: Record<string, any>) {
...
function buildQualityDuplicateGroups(entries: any[]) {
...
function detectProjectBuildCandidates(projectIdValue, bricks: any[]) {
  if (bricks.length < 2) {
    return [];
  }
