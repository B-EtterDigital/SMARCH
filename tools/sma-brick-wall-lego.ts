 ...
 * Usage: `node tools/sma-brick-wall-lego.ts --out /tmp/sma-brick-wall.html`
 */
/**
...
<footer>
  ...
  <span>generator: tools/sma-brick-wall-lego.ts</span>
  <span>docs: tools/sma-codex-wiki.ts</span>
