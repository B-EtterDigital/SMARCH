 ...
 *   `sma-backlog.mjs aggregate` at ~/DEV/SMARCH/registry/backlog.generated.json.
 *
 * Subcommands:
...
function usage() {
  console.log(`Usage:
  sma-backlog.mjs add --project <id> --title "..." --kind <kind> --severity <s> [--brick X] [--file F]...
                  [--description "..."] [--blocks-promotion-to canonical] [--effort 2] [--cost-tokens 5000]
  sma-backlog.mjs list --project <id> [--severity <s>] [--kind <k>] [--status <st>] [--json]
  sma-backlog.mjs close --project <id> --id <entry_id> --resolution "..."
  sma-backlog.mjs aggregate                            → rebuild global registry
  sma-backlog.mjs stats [--project <id>]
...
function parseArgs(argv) {
  const out = { file: [], blocksPromotionTo: [] };
