...
function usage() {
  console.log(`Usage:
  sma-graph-packets.mjs list [--project <id>] [--limit 12] [--available-only] [--json]
                             [--allow-stale] [--no-auto-refresh]
  sma-graph-packets.mjs show [--project <id>] (--rank <n>|--next) [--json]
                             [--allow-stale] [--no-auto-refresh]
  sma-graph-packets.mjs claim [--project <id>] (--rank <n>|--next) [--ttl 1200] [--json] [--dry-run]
